...
export class WidgetActivityComponent implements OnInit {
  ...
  mapping(x){
    console.log(x); 
    this.iframeMap = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3967.02524772768!2d"+x.long+"!3d"+x.lat+"!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMDcnMzguMyJTIDEwNsKwNDUnMjEuMSJF!5e0!3m2!1sen!2sid!4v1591168300015!5m2!1sen!2sid";
    this.urlSafe= this.sanitizer.bypassSecurityTrustResourceUrl(this.iframeMap);
    this.urlGmap = "https://www.google.com/maps/search/"+x.lat+",+"+x.long;
  }
